...
public class AccountController {
	...
	// create an account and add it to the list of accounts and the specified cusomter's list of accounts
	...
	// remove the account from the list of accounts and remove the account from its associated customer
	public void removeAccount(Account account/*, Customer customer*/) {
		accounts.remove(account);
		
		// cycle through the list of customers to find an account that matches the account to be removed
